...
```{r, message=FALSE}
weather_data_january <- read_csv("~/Desktop/przejściowy_2/New York City,USA 2023-01-22 to 2023-01-29.csv")

head(weather_data_january)
```

```{r, message=FALSE}
taxi_january <- read_csv("~/Desktop/przejściowy_2/taxi_january.csv")
...
```{r, message=FALSE}
weather_data_may <- read_csv(("~/Desktop/przejściowy_2/New York City,USA 2023-05-10 to 2023-05-17.csv"))

head(weather_data_may)
```
```{r, message=FALSE}
taxi_may <- read_csv("~/Desktop/przejściowy_2/taxi_may.csv")
                     col_types = cols(...1 = col_number(), 
                                      passenger_count = col_number(), 
                                      trip_distance = col_number(), 
                                      RatecodeID = col_number(), 
